...
import com.simbest.cores.utils.http.HttpClientUtil;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        String strResult =  client.getRequest(ALIPAY_GATEWAY_NEW+"_input_charset="+AlipayConfig.input_charset, sPara);
